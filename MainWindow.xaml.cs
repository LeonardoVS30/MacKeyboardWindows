...
namespace MacKeyboardWindows
{
    public partial class MainWindow : Window
    {
        ...
        private readonly SoundService _soundService; // <-- NUEVO SERVICIO
        ...
        public MainWindow()
        {
            ...
            _soundService = new SoundService(); // <-- INICIALIZAR SONIDO
        ...
        private void KeyboardHookService_KeyDown(object sender, Key e)
        {
            ...
            // SONIDO AL PRESIONAR TECLA FÍSICA
            Dispatcher.Invoke(() =>
            {
                PlaySoundForKey(e);
                HighlightKey(e, true);
        ...
        // Helper para decidir qué sonido reproducir
        private void PlaySoundForKey(Key key)
        {
            // Lista de teclas "Modificadoras" o "Grandes" que suelen sonar más grave
        ...
        #region UI Handlers (Menus, Theme, Chrome)
        ...
        // Se ha movido la lógica de Blur aquí dentro
        private void ApplyTheme(string themeName)
        {
            try
            {
                string fileName;
                WindowBlur.EnableBlur(this, false); // Desactivar blur por defecto
            ...
            catch (Exception ex) { MessageBox.Show($"Could not apply the theme: {ex.Message}"); }
        }
        ...
        private void SoundToggle_Click(object sender, RoutedEventArgs e)
        {
            ...
            {
                // menuItem.IsChecked cambia automáticamente al hacer clic gracias a IsCheckable="True"
                // Solo necesitamos pasar ese valor al servicio.
                _soundService.IsEnabled = menuItem.IsChecked;
            }
        }
        #endregion
        #endregion
